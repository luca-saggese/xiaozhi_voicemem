...
from voicemem.utils.audio.perceiver import AudioPerceiver, AudioPerception
...
class Orchestrator:
    ...
    def _extract_rb_traits(self, text: str, emotion: str) -> list[tuple[str, str]]:
        ...
        from voicemem.lang import is_zh as _is_zh
        from voicemem.lang import label_rule as _label_rule
    ...
    def Search(
        ...
        current_scene = ""
        try:
            from voicemem.utils.audio.environment.scene_classifier import (
                SceneTag,
                scene_to_response_directive,
            )
    ...
    def _finish_ingest(self, ctx: dict) -> dict:
        ...
        from voicemem.utils.common.voice_input import VoiceContent, VoiceInput
