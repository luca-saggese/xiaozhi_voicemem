...
from voicemem.utils.audio.emotion.types import VAD, EmotionAttribution, TurnEmotionRecord
from voicemem.utils.audio.emotion.vad_trigger import (
    NegativeVadTriggerConfig,
